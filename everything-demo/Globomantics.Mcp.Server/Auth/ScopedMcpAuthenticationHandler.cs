...
namespace Globomantics.Mcp.Server.Auth;
...
/// </summary>
public partial class ScopedMcpAuthenticationHandler : AuthenticationHandler<ScopedMcpAuthenticationOptions>, IAuthenticationRequestHandler
{
    ...
    /// </summary>
    public ScopedMcpAuthenticationHandler(
        IOptionsMonitor<ScopedMcpAuthenticationOptions> options,
    ...
    protected override Task HandleChallengeAsync(AuthenticationProperties properties)
    {
        ...
        {
            headerValue += $", scope=\"{Options.Scope}\"";
        }
...
public class ScopedMcpAuthenticationOptions : McpAuthenticationOptions
{
